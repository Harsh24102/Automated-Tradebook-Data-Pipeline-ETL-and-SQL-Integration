...
drop table ALL_DATA_2025;

--Table formation
CREATE TABLE ALL_DATA_2025 (
    [Server] varchar(50),
	[UserID] varchar(50),
...
--Data Replace
TRUNCATE TABLE ALL_DATA_2025;
--Data Fetch
INSERT INTO ALL_DATA_2025([Server], [UserID], [MAINTradeID], [MAINOrderID], [OrderID], [ExchangeOrderNo], [ExchangeTradeID], [OrderTime], [ExchangeOrderTime], [ExchangeTradeTime],
...
[Exchange], [SecurityID], [Symbol], [ExpiryDate], [SecurityType], [Side], [OrderType], [Quantity], [PendingQuantity], [Price], [StrikePrice], [ClientID], [ReferenceText],
[CTCLID], [MemberID], [StrategyID], [OptionType], [OpenClose], [ProductType], [ManagerID], [Pancard], [TerminalInfo], [AlgoID], [AlgoCategory], [Multiplier]
FROM  [2526 ALLOPT].[dbo].[StoreData];  

select * from ALL_DATA_2025;


-- Clean the MemberID column to remove decimal part and convert it to INT
UPDATE ALL_DATA_2025
...
--To check unaligned data
select * from ALL_DATA_2025
where Quantity = 'sell';

--Code to replace Unaligned row 
UPDATE ALL_DATA_2025
SET 
	Server = 'Default',
	UserID = 'NORMAL',
	...
	MAINOrderID = '9682',
	OrderID = '1337',
	ExchangeOrderNo = '1744791966010828176',
	ExchangeTradeID = '2838790',
	OrderTime = '',
	[ExchangeOrderTime] = '20250416-14:00:14',
	[ExchangeTradeTime] = '20250416-14:00:14',
	Exchange = 'BSEFO',
	SecurityID = '877913',
	Symbol = 'BSX',
	ExpiryDate = '22APR2025',
	SecurityType = 'OPTIDX',
	Side = 'Sell',
	OrderType = 'Limit',
	Quantity = 20,
	...
	ClientID = 'D016',
    MemberID = '6590',
    ReferenceText = CONCAT(Symbol, ExpiryDate, StrikePrice, OptionType),
    CTCLID = '659000211',
    StrategyID = '314',
    OptionType = 'PE',
    OpenClose = '',
    ...
    ManagerID = 'ALLOPT73',
    Pancard = 'ANPPP5536N',
    TerminalInfo = '4000010002011388',
    AlgoID = '1',
	[AlgoCategory] = '',
	[Multiplier] = 1.00
WHERE MemberID = '17 22 77 233 s';