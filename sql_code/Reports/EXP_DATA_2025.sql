...
drop table EXP_DATA_2025;

--Table formation
CREATE TABLE EXP_DATA_2025 (
    [Server] varchar(50),
	[UserID] varchar(50),
...
--Data Replace
TRUNCATE TABLE EXP_DATA_2025;
--Data Fetch
INSERT INTO EXP_DATA_2025([Server], [UserID], [MAINTradeID], [MAINOrderID], [OrderID], [ExchangeOrderNo], [ExchangeTradeID], [OrderTime], [ExchangeOrderTime], [ExchangeTradeTime],
...
[Exchange], [SecurityID], [Symbol], [ExpiryDate], [SecurityType], [Side], [OrderType], [Quantity], [PendingQuantity], [Price], [StrikePrice], [ClientID], [ReferenceText],
[CTCLID], [MemberID], [StrategyID], [OptionType], [OpenClose], [ProductType], [ManagerID], [Pancard], [TerminalInfo], [AlgoID], [AlgoCategory], [Multiplier]
FROM [2526 EXPOPT].dbo.StroedData;  

select * from EXP_DATA_2025;


-- Clean the MemberID column to remove decimal part and convert it to INT
UPDATE EXP_DATA_2025
